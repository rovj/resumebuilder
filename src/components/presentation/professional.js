    ...
    <div className="container med contact">
            <div className="section funnel-section">
                <div className="form-card">
                    ...
                    <div className="form-section">
                        <div className="input-group full"><label>Skills</label>
                            <div className="effect"><textarea rows={5} name={fieldCd.Skills} value={getFieldData(fieldCd.Skills)}  onChange={onchange}  /><span></span>
                            </div>
                            <div className="error"></div>
                        </div>

                        <div className="input-group full"><label>Experience</label>
                            <div className="effect"><textarea rows={5} name={fieldCd.Experience}  value={getFieldData(fieldCd.Experience)}  onChange={onchange}/><span></span>
                            </div>
                            <div className="error"></div>
                        </div>

                        <div className="input-group full"><label>Certifications</label>
                            <div className="effect"><textarea rows={5} name={fieldCd.Certifications}   value={getFieldData(fieldCd.Certifications)}  onChange={onchange}/><span></span>
                            </div>
                            <div className="error"></div>
                        </div>

                        <div className="input-group full"><label>Achievements</label>
                            <div className="effect"><textarea rows={5}  name={fieldCd.Achievements}  value={getFieldData(fieldCd.Achievements)}  onChange={onchange} /><span></span>
                            </div>
                            <div className="error"></div>
                        </div>
                ...
                <div className="preview-card">
                    <ResumePreview contactSection={contact} educationSection={education} skinCd={document?.skinCd} professionalSection={professionalDetails}></ResumePreview>
                </div>
