                ...
                <div className="form-card">
                    ...
                    <div className="form-section">
                        <div className="input-group"><label>First Name</label>
                            ...
                            <div className="error">{error[fieldCd.FirstName]? error[fieldCd.FirstName] : ""}</div>
                        </div>
                        ...
                        <div className="input-group"><label>Last Name</label>
                            ...
                            <div className="error">{error[fieldCd.LastName]? error[fieldCd.LastName] : ""}</div>
                        </div>

                        <div className="input-group full"><label>Professional Summary</label>
                            <div className="effect"><textarea rows={5} name={fieldCd.ProfSummary}   value={getFieldData(fieldCd.ProfSummary)}  onChange={onchange}/><span></span>
                            </div>
                        ...
                        <div className="input-group"><label>Email</label>
                            ...
                            <div className="error">{error[fieldCd.Email]? error[fieldCd.Email] : ""}</div>
                        </div>
                        ...
                        <div className="input-group"><label>Phone</label>
                            ...
                            <div className="error">{error[fieldCd.Phone]? error[fieldCd.Phone] : ""}</div>
                        </div>
